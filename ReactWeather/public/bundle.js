	...
	var Weather = React.createClass({
	    ...
	    render: function render() {
	        var _state = this.state,
	            ...
	            temp = _state.temp,
	            location = _state.location; // access those in handleSearch
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var OPEN_WEATHER_MAP_URL = 'http://api.openweathermap.org/data/2.5/weather?appid=7960c1b1b4718b05110e495c2f37e1ac&units=imperial';
